import os
from flask import Blueprint, redirect, url_for, flash, render_template, request, current_app, send_from_directory, abort
...
def show_tag(tag_id, order):
    ...
    if order == 'by_collects':
        photos.sort(key=lambda x: len(x.collectors))
        order_rule = 'collects'
